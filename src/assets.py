...
def load_assets():
    ...
    assets['background_day_1']  = pygame.transform.scale(assets['background_day_1'], (window_width * 7, window_height))
    assets['platform_img']      = pygame.image.load('../assets/img/platform.png').convert_alpha()
    assets['platform_img']      = pygame.transform.scale(assets['platform_img'], (window_height//10, window_height//10))
